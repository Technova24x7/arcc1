...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
            <h1 class="text-primary m-0"><img class="me-3" src="img/icons/icon-1.png" alt="Icon"><?php  echo( $_GET['name']) ?></h1>
        </a>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-end">
                        ...
                        Designed By <a href="https://technove24.com">Technove24</a>
                        <br> Distributed By: <a class="border-bottom" href="https://technove24.com" target="_blank">Technove24</a>
                    </div>
                </div>
            </div>
        </div>
